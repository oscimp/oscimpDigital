...
\item Connect {\tt data\_a} and {\tt data\_b} of the ADCs to the two free inputs
of the {\tt dupplReal\_1\_to\_2} blocks
\item {\tt dataComplex\_to\_RAM}: configure {\tt Data Size} to 14 bits et 
...
Compilation is achieved from the {\tt \$OSCIMP\_DIGITAL\_DRIVER/data16Complex\_to\_ram\_core}
...
\item {\tt data16Complex\_to\_ram\_core.ko} in {\tt modules/}
\end{enumerate} 
