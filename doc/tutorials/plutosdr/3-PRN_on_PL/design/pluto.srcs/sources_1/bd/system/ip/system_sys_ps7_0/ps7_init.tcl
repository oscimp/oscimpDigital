...
proc ps7_clock_init_data_3_0 {} {
    ...
    mask_write 0XF800012C 0x01FFCCCD 0x01EC400D
    mwr -force 0XF8000004 0x0000767B
}
proc ps7_ddr_init_data_3_0 {} {
    ...
    mask_write 0XF800612C 0x000FFFFF 0x00028406
    mask_write 0XF8006130 0x000FFFFF 0x00028406
    ...
    mask_write 0XF8006154 0x000FFFFF 0x00000086
    mask_write 0XF8006158 0x000FFFFF 0x00000086
    ...
    mask_write 0XF800616C 0x001FFFFF 0x000000F6
    mask_write 0XF8006170 0x001FFFFF 0x000000F9
    mask_write 0XF8006174 0x001FFFFF 0x000000F9
    mask_write 0XF800617C 0x000FFFFF 0x000000C6
...
proc ps7_mio_init_data_3_0 {} {
    ...
    mask_write 0XF8000700 0x00003FFF 0x00001200
    ...
    mask_write 0XF8000730 0x00003FFF 0x000012E0
    mask_write 0XF8000734 0x00003FFF 0x000012E1
    mask_write 0XF8000738 0x00003FFF 0x00001200
    mask_write 0XF800073C 0x00003FFF 0x00001200
...
proc ps7_peripherals_init_data_3_0 {} {
    ...
    mask_write 0XE000A244 0x003FFFFF 0x00100000
    mask_write 0XE000A00C 0x003F003F 0x002F0010
    mask_write 0XE000A248 0x003FFFFF 0x00100000
    mask_write 0XE000A00C 0x003F003F 0x002F0000
